...
* Entity Property in _UPPER_CASE_ (due to XS Engine)

Common RESTful Protocol - _lower_case_

    id, name, zip_code

OData Protocol - _PascalCase_

    ID, Name, ZipCode

XS Engine, consist with DB Table - _UPPER_CASE_
...
* Navigation Property in _PascalCase_
