...
SAP HANA Client
    ...
    \\vantipsoftware.pgdev.sap.corp\software\SAP\HANA\1.0 Rev 74\client\NTamd64
...
### User Store
    ...
    $ hdbuserstore set TRP_SYS 10.58.185.121:30015 SYSTEM Abcd1234
    $ hdbuserstore list
...
Create workspace
    ...
    $ cd target
    $ regi create workspace hanaxs ROGERX --force
    $ cd hanaxs

    $ regi track roger.ui
    $ regi checkout --lineEnd=UNIX
    $ regi resolve --local
    $ regi resolve package roger.ui --local

    $ rm -rf roger/ui/[!.]*

    $ shopt -s extglob # to enable extglob
    $ cp -r ../trp-ui/!(*-INF) roger/ui/

    $ cp -r ../trp-ui/[!MW]* roger/ui/
    $ rm -rf roger/ui/META-INF/
    $ rm -rf roger/ui/WEB-INF/
...
shopt -s extglob
cp -r ../trp-ui/!(*-INF) sap/tm/trp/ui/

cp ../trp-ui/config/config-test/* sap/tm/trp/ui/config/
